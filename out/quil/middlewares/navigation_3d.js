...
var vec__8867 = axis;
var a_x = cljs.core.nth.call(null,vec__8867,(0),null);
var a_y = cljs.core.nth.call(null,vec__8867,(1),null);
var a_z = cljs.core.nth.call(null,vec__8867,(2),null);
var vec__8870 = v;
var x = cljs.core.nth.call(null,vec__8870,(0),null);
var y = cljs.core.nth.call(null,vec__8870,(1),null);
var z = cljs.core.nth.call(null,vec__8870,(2),null);
 ...
 */
quil.middlewares.navigation_3d.cross_product = (function quil$middlewares$navigation_3d$cross_product(p__8873,p__8874){
var vec__8881 = p__8873;
var u1 = cljs.core.nth.call(null,vec__8881,(0),null);
var u2 = cljs.core.nth.call(null,vec__8881,(1),null);
var u3 = cljs.core.nth.call(null,vec__8881,(2),null);
var vec__8884 = p__8874;
var v1 = cljs.core.nth.call(null,vec__8884,(0),null);
var v2 = cljs.core.nth.call(null,vec__8884,(1),null);
var v3 = cljs.core.nth.call(null,vec__8884,(2),null);
...
return cljs.core.mapv.call(null,(function (p1__8887_SHARP_){
return (p1__8887_SHARP_ * mult);
}),v);
});
/**
 * Sum of 2 vectors.
...
return quil.middlewares.navigation_3d.rotate_by_axis_and_angle.call(null,p1__8888_SHARP_,axis,angle);
});})(axis))
;
...
return quil.middlewares.navigation_3d.rotate_ud.call(null,quil.middlewares.navigation_3d.rotate_lr.call(null,p1__8889_SHARP_,angle_lr),angle_ud);
...
var map__8896 = new cljs.core.Keyword(null,"navigation-3d","navigation-3d",682305301).cljs$core$IFn$_invoke$arity$1(state);
...
var up = cljs.core.get.call(null,map__8896__$1,new cljs.core.Keyword(null,"up","up",-269712113));
var straight = cljs.core.get.call(null,map__8896__$1,new cljs.core.Keyword(null,"straight","straight",-1252567854));
var temp__4655__auto__ = (function (){var pred__8898 = cljs.core._EQ_;
var expr__8899 = new cljs.core.Keyword(null,"key","key",-1516042587).cljs$core$IFn$_invoke$arity$1(event);
if(cljs.core.truth_(pred__8898.call(null,new cljs.core.Keyword(null,"w","w",354169001),expr__8899))){
return straight;
} else {
if(cljs.core.truth_(pred__8898.call(null,new cljs.core.Keyword(null,"s","s",1705939918),expr__8899))){
return quil.middlewares.navigation_3d.v_opposite.call(null,straight);
} else {
if(cljs.core.truth_(pred__8898.call(null,quil.middlewares.navigation_3d.space,expr__8899))){
return quil.middlewares.navigation_3d.v_opposite.call(null,up);
} else {
if(cljs.core.truth_(pred__8898.call(null,new cljs.core.Keyword(null,"z","z",-789527183),expr__8899))){
return up;
} else {
if(cljs.core.truth_(pred__8898.call(null,new cljs.core.Keyword(null,"d","d",1972142424),expr__8899))){
return quil.middlewares.navigation_3d.cross_product.call(null,straight,up);
} else {
if(cljs.core.truth_(pred__8898.call(null,new cljs.core.Keyword(null,"a","a",-2123407586),expr__8899))){
...
return cljs.core.update_in.call(null,state,new cljs.core.PersistentVector(null, 2, 5, cljs.core.PersistentVector.EMPTY_NODE, [new cljs.core.Keyword(null,"navigation-3d","navigation-3d",682305301),new cljs.core.Keyword(null,"position","position",-2011731912)], null),((function (dir,temp__4655__auto__,map__8896,map__8896__$1,up,straight){
return (function (p1__8890_SHARP_){
return quil.middlewares.navigation_3d.v_plus.call(null,p1__8890_SHARP_,quil.middlewares.navigation_3d.v_mult.call(null,dir,step_size));
});})(dir,temp__4655__auto__,map__8896,map__8896__$1,up,straight))
);
} else {
return state;
}
...
return cljs.core.merge.call(null,initial_state,p1__8901_SHARP_);
});})(initial_state))
);
});
/**
...
var map__8913_8924 = new cljs.core.Keyword(null,"navigation-3d","navigation-3d",682305301).cljs$core$IFn$_invoke$arity$1(state);
var map__8913_8925__$1 = ((((!((map__8913_8924 == null)))?((((map__8913_8924.cljs$lang$protocol_mask$partition0$ & (64))) || ((cljs.core.PROTOCOL_SENTINEL === map__8913_8924.cljs$core$ISeq$)))?true:false):false))?cljs.core.apply.call(null,cljs.core.hash_map,map__8913_8924):map__8913_8924);
var vec__8914_8926 = cljs.core.get.call(null,map__8913_8925__$1,new cljs.core.Keyword(null,"straight","straight",-1252567854));
var c_x_8927 = cljs.core.nth.call(null,vec__8914_8926,(0),null);
var c_y_8928 = cljs.core.nth.call(null,vec__8914_8926,(1),null);
var c_z_8929 = cljs.core.nth.call(null,vec__8914_8926,(2),null);
var vec__8917_8930 = cljs.core.get.call(null,map__8913_8925__$1,new cljs.core.Keyword(null,"up","up",-269712113));
var u_x_8931 = cljs.core.nth.call(null,vec__8917_8930,(0),null);
var u_y_8932 = cljs.core.nth.call(null,vec__8917_8930,(1),null);
var u_z_8933 = cljs.core.nth.call(null,vec__8917_8930,(2),null);
var vec__8920_8934 = cljs.core.get.call(null,map__8913_8925__$1,new cljs.core.Keyword(null,"position","position",-2011731912));
var p_x_8935 = cljs.core.nth.call(null,vec__8920_8934,(0),null);
var p_y_8936 = cljs.core.nth.call(null,vec__8920_8934,(1),null);
var p_z_8937 = cljs.core.nth.call(null,vec__8920_8934,(2),null);
quil.core.camera.call(null,p_x_8935,p_y_8936,p_z_8937,(p_x_8935 + c_x_8927),(p_y_8936 + c_y_8928),(p_z_8937 + c_z_8929),u_x_8931,u_y_8932,u_z_8933);
