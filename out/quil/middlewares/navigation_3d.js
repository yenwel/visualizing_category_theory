...
var vec__9329 = axis;
var a_x = cljs.core.nth.call(null,vec__9329,(0),null);
var a_y = cljs.core.nth.call(null,vec__9329,(1),null);
var a_z = cljs.core.nth.call(null,vec__9329,(2),null);
var vec__9332 = v;
var x = cljs.core.nth.call(null,vec__9332,(0),null);
var y = cljs.core.nth.call(null,vec__9332,(1),null);
var z = cljs.core.nth.call(null,vec__9332,(2),null);
 ...
 */
quil.middlewares.navigation_3d.cross_product = (function quil$middlewares$navigation_3d$cross_product(p__9335,p__9336){
var vec__9343 = p__9335;
var u1 = cljs.core.nth.call(null,vec__9343,(0),null);
var u2 = cljs.core.nth.call(null,vec__9343,(1),null);
var u3 = cljs.core.nth.call(null,vec__9343,(2),null);
var vec__9346 = p__9336;
var v1 = cljs.core.nth.call(null,vec__9346,(0),null);
var v2 = cljs.core.nth.call(null,vec__9346,(1),null);
var v3 = cljs.core.nth.call(null,vec__9346,(2),null);
...
return cljs.core.mapv.call(null,(function (p1__9349_SHARP_){
return (p1__9349_SHARP_ * mult);
}),v);
});
/**
 * Sum of 2 vectors.
...
return quil.middlewares.navigation_3d.rotate_by_axis_and_angle.call(null,p1__9350_SHARP_,axis,angle);
});})(axis))
;
...
return quil.middlewares.navigation_3d.rotate_ud.call(null,quil.middlewares.navigation_3d.rotate_lr.call(null,p1__9351_SHARP_,angle_lr),angle_ud);
...
var map__9358 = new cljs.core.Keyword(null,"navigation-3d","navigation-3d",682305301).cljs$core$IFn$_invoke$arity$1(state);
...
var up = cljs.core.get.call(null,map__9358__$1,new cljs.core.Keyword(null,"up","up",-269712113));
var straight = cljs.core.get.call(null,map__9358__$1,new cljs.core.Keyword(null,"straight","straight",-1252567854));
var temp__4655__auto__ = (function (){var pred__9360 = cljs.core._EQ_;
var expr__9361 = new cljs.core.Keyword(null,"key","key",-1516042587).cljs$core$IFn$_invoke$arity$1(event);
if(cljs.core.truth_(pred__9360.call(null,new cljs.core.Keyword(null,"w","w",354169001),expr__9361))){
return straight;
} else {
if(cljs.core.truth_(pred__9360.call(null,new cljs.core.Keyword(null,"s","s",1705939918),expr__9361))){
return quil.middlewares.navigation_3d.v_opposite.call(null,straight);
} else {
if(cljs.core.truth_(pred__9360.call(null,quil.middlewares.navigation_3d.space,expr__9361))){
return quil.middlewares.navigation_3d.v_opposite.call(null,up);
} else {
if(cljs.core.truth_(pred__9360.call(null,new cljs.core.Keyword(null,"z","z",-789527183),expr__9361))){
return up;
} else {
if(cljs.core.truth_(pred__9360.call(null,new cljs.core.Keyword(null,"d","d",1972142424),expr__9361))){
return quil.middlewares.navigation_3d.cross_product.call(null,straight,up);
} else {
if(cljs.core.truth_(pred__9360.call(null,new cljs.core.Keyword(null,"a","a",-2123407586),expr__9361))){
...
return cljs.core.update_in.call(null,state,new cljs.core.PersistentVector(null, 2, 5, cljs.core.PersistentVector.EMPTY_NODE, [new cljs.core.Keyword(null,"navigation-3d","navigation-3d",682305301),new cljs.core.Keyword(null,"position","position",-2011731912)], null),((function (dir,temp__4655__auto__,map__9358,map__9358__$1,up,straight){
return (function (p1__9352_SHARP_){
return quil.middlewares.navigation_3d.v_plus.call(null,p1__9352_SHARP_,quil.middlewares.navigation_3d.v_mult.call(null,dir,step_size));
});})(dir,temp__4655__auto__,map__9358,map__9358__$1,up,straight))
);
} else {
return state;
}
...
return cljs.core.merge.call(null,initial_state,p1__9363_SHARP_);
});})(initial_state))
);
});
/**
...
var map__9375_9386 = new cljs.core.Keyword(null,"navigation-3d","navigation-3d",682305301).cljs$core$IFn$_invoke$arity$1(state);
var map__9375_9387__$1 = ((((!((map__9375_9386 == null)))?((((map__9375_9386.cljs$lang$protocol_mask$partition0$ & (64))) || ((cljs.core.PROTOCOL_SENTINEL === map__9375_9386.cljs$core$ISeq$)))?true:false):false))?cljs.core.apply.call(null,cljs.core.hash_map,map__9375_9386):map__9375_9386);
var vec__9376_9388 = cljs.core.get.call(null,map__9375_9387__$1,new cljs.core.Keyword(null,"straight","straight",-1252567854));
var c_x_9389 = cljs.core.nth.call(null,vec__9376_9388,(0),null);
var c_y_9390 = cljs.core.nth.call(null,vec__9376_9388,(1),null);
var c_z_9391 = cljs.core.nth.call(null,vec__9376_9388,(2),null);
var vec__9379_9392 = cljs.core.get.call(null,map__9375_9387__$1,new cljs.core.Keyword(null,"up","up",-269712113));
var u_x_9393 = cljs.core.nth.call(null,vec__9379_9392,(0),null);
var u_y_9394 = cljs.core.nth.call(null,vec__9379_9392,(1),null);
var u_z_9395 = cljs.core.nth.call(null,vec__9379_9392,(2),null);
var vec__9382_9396 = cljs.core.get.call(null,map__9375_9387__$1,new cljs.core.Keyword(null,"position","position",-2011731912));
var p_x_9397 = cljs.core.nth.call(null,vec__9382_9396,(0),null);
var p_y_9398 = cljs.core.nth.call(null,vec__9382_9396,(1),null);
var p_z_9399 = cljs.core.nth.call(null,vec__9382_9396,(2),null);
quil.core.camera.call(null,p_x_9397,p_y_9398,p_z_9399,(p_x_9397 + c_x_9389),(p_y_9398 + c_y_9390),(p_z_9399 + c_z_9391),u_x_9393,u_y_9394,u_z_9395);
